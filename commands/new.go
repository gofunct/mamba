...
import (
	...
	"github.com/gofunct/common/pkg/generator"
...
func init() {
	...
	logger.LogF("Flag error", viper.BindPFlag("name", newCmd.PersistentFlags().Lookup("name")))
	logger.LogF("Flag error", viper.BindPFlag("description", newCmd.PersistentFlags().Lookup("description")))
	logger.LogF("Flag error", viper.BindPFlag("github", RootCmd.PersistentFlags().Lookup("github")))
	logger.LogF("Flag error", viper.BindPFlag("gitinit", RootCmd.PersistentFlags().Lookup("git-init")))
	logger.LogF("Flag error", viper.BindPFlag("contract", RootCmd.PersistentFlags().Lookup("contract-example")))
}
