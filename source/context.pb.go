...
func (*Context) Descriptor() ([]byte, []int) {
	return fileDescriptor_context_96cfc0cb9dc5376d, []int{0}
}
...
func (*ContextRule) Descriptor() ([]byte, []int) {
	return fileDescriptor_context_96cfc0cb9dc5376d, []int{1}
}
...
func init() {
	proto.RegisterType((*Context)(nil), "source.Context")
	proto.RegisterType((*ContextRule)(nil), "source.ContextRule")
}
...
func (m *ContextRule) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.AllowedRequestExtensions) > 0 {
		for _, s := range m.AllowedRequestExtensions {
			dAtA[i] = 0x22
			i++
			l = len(s)
			for l >= 1<<7 {
	...
	if len(m.AllowedResponseExtensions) > 0 {
		for _, s := range m.AllowedResponseExtensions {
			dAtA[i] = 0x2a
			i++
			l = len(s)
			for l >= 1<<7 {
...
func (m *ContextRule) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AllowedRequestExtensions", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.AllowedRequestExtensions = append(m.AllowedRequestExtensions, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AllowedResponseExtensions", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.AllowedResponseExtensions = append(m.AllowedResponseExtensions, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipContext(dAtA[iNdEx:])
...
func init() { proto.RegisterFile("source/context.proto", fileDescriptor_context_96cfc0cb9dc5376d) }

var fileDescriptor_context_96cfc0cb9dc5376d = []byte{
	// 274 bytes of a gzipped FileDescriptorProto
	,
}
