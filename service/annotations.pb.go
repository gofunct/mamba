...
// source: service/annotations.proto
...
func (*Http) Descriptor() ([]byte, []int) {
	return fileDescriptor_annotations_0cf61f212022c9d4, []int{0}
}
...
func (*HttpRule) Descriptor() ([]byte, []int) {
	return fileDescriptor_annotations_0cf61f212022c9d4, []int{1}
}
...
func (*CustomHttpPattern) Descriptor() ([]byte, []int) {
	return fileDescriptor_annotations_0cf61f212022c9d4, []int{2}
}
...
func init() {
	proto.RegisterType((*Http)(nil), "service.Http")
	proto.RegisterType((*HttpRule)(nil), "service.HttpRule")
	proto.RegisterType((*CustomHttpPattern)(nil), "service.CustomHttpPattern")
}
...
func (m *HttpRule) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Selector) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintAnnotations(dAtA, i, uint64(len(m.Selector)))
	...
	if len(m.Body) > 0 {
		dAtA[i] = 0x3a
		i++
		i = encodeVarintAnnotations(dAtA, i, uint64(len(m.Body)))
	...
	if len(m.ResponseBody) > 0 {
		dAtA[i] = 0x62
		i++
		i = encodeVarintAnnotations(dAtA, i, uint64(len(m.ResponseBody)))
...
func (m *HttpRule_Get) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x12
	i++
	i = encodeVarintAnnotations(dAtA, i, uint64(len(m.Get)))
	i += copy(dAtA[i:], m.Get)
	return i, nil
}
func (m *HttpRule_Put) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x1a
	i++
	i = encodeVarintAnnotations(dAtA, i, uint64(len(m.Put)))
	i += copy(dAtA[i:], m.Put)
	return i, nil
}
func (m *HttpRule_Post) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x22
	i++
	i = encodeVarintAnnotations(dAtA, i, uint64(len(m.Post)))
...
func (m *HttpRule_Delete) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x2a
	i++
	i = encodeVarintAnnotations(dAtA, i, uint64(len(m.Delete)))
...
func (m *HttpRule_Patch) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x32
	i++
	i = encodeVarintAnnotations(dAtA, i, uint64(len(m.Patch)))
...
func (m *HttpRule_Custom) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Custom != nil {
		dAtA[i] = 0x42
		i++
		i = encodeVarintAnnotations(dAtA, i, uint64(m.Custom.Size()))
...
func (m *CustomHttpPattern) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Kind) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintAnnotations(dAtA, i, uint64(len(m.Kind)))
		i += copy(dAtA[i:], m.Kind)
	}
	if len(m.Path) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintAnnotations(dAtA, i, uint64(len(m.Path)))
...
func init() {
	proto.RegisterFile("service/annotations.proto", fileDescriptor_annotations_0cf61f212022c9d4)
}

var fileDescriptor_annotations_0cf61f212022c9d4 = []byte{
	// 421 bytes of a gzipped FileDescriptorProto
	,
}
